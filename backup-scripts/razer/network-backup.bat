...
robocopy "C:\Users\jimmy\Pictures" "%DESTINATION_ROOT%\Pictures" %RC_FLAGS% /log+:"LOGS\razer\network-backup-%_date%_%_time%-Pictures.log" /XD C:\Users\jimmy\Pictures\Photography
robocopy "C:\Users\jimmy\Videos" "%DESTINATION_ROOT%\Videos" %RC_FLAGS% /log+:"LOGS\razer\network-backup-%_date%_%_time%-Videos.log"
robocopy "C:\Users\jimmy\Documents" "%DESTINATION_ROOT%\Documents" %RC_FLAGS% /log+:"LOGS\razer\network-backup-%_date%_%_time%-Documents.log" /XD "C:\Users\jimmy\Documents\Projects"
